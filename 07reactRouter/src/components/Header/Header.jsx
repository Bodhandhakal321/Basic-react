...
import {Link ,NavLink} from 'react-router-dom' //navlink for more features using a tag tehre is page refrence so use link
 //navlink for more additional features 
